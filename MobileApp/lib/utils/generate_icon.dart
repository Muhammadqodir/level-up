...
class GenerateIcon {
  Future<String> getIcon(String q) async {
    ...
    print('https://www.flaticon.com/search?word=' + q + '&color=black&order_by=4');
  ...
  Future<List<Widget>> getCards(String theme) async {
    ...
    print("https://serpapi.com/search.json?engine=google&q=$theme курсы&gl=ru&api_key=95b8795a8f0ab0ddc95a5e571153f7a01fbd841a1e56a6a0c3ecfa4fd404f57a");
